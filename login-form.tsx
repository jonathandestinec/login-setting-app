            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-[#222222] border-[#ea9276] text-white focus:border-[#ea9276] focus:ring-[#ea9276]"
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    style={{ caretColor: "#ea9276" }}
                    className="bg-[#222222] border-[#ea9276] text-white pr-10 focus:border-[#ea9276] focus:ring-[#ea9276]"
                  />
                  <button
                    type="button"
